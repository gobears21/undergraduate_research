...
/opt/gcc-8.2.0/bin/g++ -std=c++17 -DBUILD_VE vec_add_single_task.cpp -o vec_add_single_task.out -I$NEO_SYCL  -I$VEO_HEADER_PATH -lpthread -L$VEO_LIB_PATH -Wl,-rpath=$VEO_LIB_PATH -lveo
