...
/opt/gcc-8.2.0/bin/g++ -std=c++17 -DBUILD_VE sycl_ve_vecadd-2.cpp -o sycl_ve_vecadd-2 -I$NEO_SYCL  -I$VEO_HEADER_PATH -lpthread -L$VEO_LIB_PATH -Wl,-rpath=$VEO_LIB_PATH -lveo
