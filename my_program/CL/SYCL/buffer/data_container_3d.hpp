...
class DataContainerND<T, 3> : public DataContainer {
 ...
 public:
  explicit DataContainerND(const cl::sycl::range<3> &r) : data_range(r), need_deallocate(true) {
  ...
  explicit DataContainerND(T *data, const cl::sycl::range<3> &r) : data_range(r), need_deallocate(false) {
